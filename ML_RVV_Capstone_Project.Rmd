...
```{r Baseline reflexion on time effect 2, message=FALSE}
...
which slightly(almost residual) affect the model in a positive way.  It is important to note that at each step improving became more difficult, and the quantity gained in terms of RMSE or MAE is not always worhty in terms of computer resources needed and calculus time.
