...
So now we are ready to create a train and a test set to assess the accuracy of the models we will implement. 
...
And finally we can start to implement our candidate modells
