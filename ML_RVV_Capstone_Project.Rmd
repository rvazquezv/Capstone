...
Comparing Figure 4, Figure 5 and Figure 9 and also RMSE and MAE calculated for each of those process it is possible to figure out the influence of each of those bias on final predictions, and which effects seem to affect more to final predictions 
