...
On their paper Y. Koren writes about improving baseline predictor by applying matrix factorization with temporal dynamics. He states they modeled SVD++ based on the following prediction rule:
...
small_edx<-small_edx %>% mutate(sum_b_g=0)
...
```
 ...
 compare results with previous ones and finally working on matrix factorization on this smaller matrix
