...
## Save results to table
Results<-rbind(Results,tibble(method = "Movie Bias reg + User bias reg+ time effect ", RMSE = movbiasregbin_rmse, MAE = movbiasregbin_mae))
Results
```
...
## Save results to table
Results<-rbind(Results,tibble(method = "Movie Bias reg + User bias reg+ time effect + dev_u(t)", RMSE = usertimebias_rmse,MAE = usertimebias_mae))
Results
